import BaseComponent from "./generic/BaseCmponent"
...
class Select extends BaseComponent {
  ...
  constructor(rootElement) {
    ...
    this.updateTabIndexes(MatchMedia.mobile.matches)
  ...
  fixDropdownPosition = () => {
    ...
    const isButtonOnTheLeftSide = buttonCenterX < viewPortCenterX
